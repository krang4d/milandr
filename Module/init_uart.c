...
void InitUart(void)
{
  ...
  //Параметры делителя при частоте = 32000000Гц и скорости = 115200
  MDR_UART2->IBRD = 0x8; //целая часть делителя скорости
  MDR_UART2->FBRD = 0x2c; //дробная часть делителя скорости
